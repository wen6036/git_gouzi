...
class Cache
{
    ...
    {
        empty(self::$cachepath) && self::$cachepath = getcwd() . DIRECTORY_SEPARATOR . 'Runtime'.DIRECTORY_SEPARATOR .'Cache'. DIRECTORY_SEPARATOR .'ChatCache' . DIRECTORY_SEPARATOR;
