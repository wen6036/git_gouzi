...
class Showdata extends Base
{
    public function index()
    {
        ...
        if (isset($this->param['export_data']) && $this->param['export_data'] == 1) {
            ...
            return $this->export($header, $body, "展示区-" . date('Y-m-d-H-i-s'), '2007');
        }
